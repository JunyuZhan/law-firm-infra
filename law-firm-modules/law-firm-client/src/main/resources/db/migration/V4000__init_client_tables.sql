...
CREATE TABLE IF NOT EXISTS `client_info` (
  ...
  `type` tinyint NOT NULL DEFAULT '1' COMMENT '客户类型：1-个人客户，2-企业客户，3-政府机构，0-其他',
  `source` tinyint DEFAULT NULL COMMENT '客户来源：1-直接咨询，2-老客户介绍，3-合作伙伴介绍，4-广告宣传，5-活动营销，0-其他',
  `industry` varchar(50) DEFAULT NULL COMMENT '所属行业',
  `level` tinyint DEFAULT '1' COMMENT '客户等级：1-普通客户，2-重要客户，3-核心客户，4-VIP客户',
  `status` tinyint NOT NULL DEFAULT '1' COMMENT '状态：1-潜在客户，2-意向客户，3-成交客户，4-流失客户，5-黑名单客户',
  ...
  `id_type` tinyint DEFAULT NULL COMMENT '证件类型（个人客户）：1-身份证，2-护照，3-军官证，4-港澳通行证，5-台湾通行证，0-其他',
  `id_number` varchar(50) DEFAULT NULL COMMENT '证件号码（个人客户）',
  `remark` varchar(500) DEFAULT NULL COMMENT '备注',
  `follow_up_status` tinyint DEFAULT '1' COMMENT '跟进状态：1-未跟进，2-跟进中，3-已跟进，4-已成交，5-已流失',
  `last_follow_up_time` datetime DEFAULT NULL COMMENT '最近跟进时间',
  `next_follow_up_time` datetime DEFAULT NULL COMMENT '下次跟进时间',
  `follow_up_times` int DEFAULT '0' COMMENT '跟进次数',
  `responsible_lawyer_id` bigint DEFAULT NULL COMMENT '负责律师ID',
...
CREATE TABLE IF NOT EXISTS `client_contact` (
  ...
  `is_decision_maker` tinyint NOT NULL DEFAULT '0' COMMENT '是否决策者：0-否，1-是',
  `remark` varchar(500) DEFAULT NULL COMMENT '备注',
  `deleted` tinyint NOT NULL DEFAULT '0' COMMENT '是否删除：0-否，1-是',
  `tenant_id` bigint NOT NULL DEFAULT '0' COMMENT '租户ID',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
...
CREATE TABLE IF NOT EXISTS `client_follow_up` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `client_id` bigint NOT NULL COMMENT '客户ID',
  `follow_up_type` tinyint NOT NULL DEFAULT '1' COMMENT '跟进方式：1-电话跟进，2-邮件跟进，3-会议跟进，4-拜访跟进，5-其他',
  `follow_up_time` datetime NOT NULL COMMENT '跟进时间',
  `content` text NOT NULL COMMENT '跟进内容',
  `next_follow_up_time` datetime DEFAULT NULL COMMENT '下次跟进时间',
  `next_plan` varchar(500) DEFAULT NULL COMMENT '下次计划',
  `follow_up_result` tinyint DEFAULT NULL COMMENT '跟进结果：1-意向增强，2-意向不变，3-意向减弱，4-成交，5-无法接通，6-无意向',
  `follow_up_by` bigint NOT NULL COMMENT '跟进人ID',
