...
public class ScheduleReminderController {
    ...
    @PostMapping
    @PreAuthorize("hasAuthority('" + SCHEDULE_REMINDER_CREATE + "')")
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasAuthority('" + SCHEDULE_REMINDER_EDIT + "')")
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasAuthority('" + SCHEDULE_REMINDER_DELETE + "')")
    ...
    @GetMapping("/{id}")
    @PreAuthorize("hasAuthority('" + SCHEDULE_REMINDER_VIEW + "')")
