...
@Tag(name = "案件团队管理", description = "提供案件团队相关的管理功能，包括：\n" +
        "1. 参与方管理：添加、更新、删除案件相关方（如原告、被告等）\n" +
        "2. 团队成员管理：管理案件办理团队（如主办律师、协办律师等）\n" +
        "3. 参与方信息查询：支持按类型、名称等条件查询\n" +
        "4. 团队成员协作：支持团队成员之间的任务分配和协作")
