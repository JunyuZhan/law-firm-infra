...
public class CaseParticipantVO extends BaseVO {
    ...
    public boolean isClient() {
        return this.participantType != null && 
               this.participantType == CaseParticipantTypeEnum.CLIENT;
    }
    ...
    public boolean isOpposingParty() {
        return this.participantType != null && 
               this.participantType == CaseParticipantTypeEnum.OPPOSING_PARTY;
    }
    ...
    public boolean isWitness() {
        return this.participantType != null && 
               this.participantType == CaseParticipantTypeEnum.WITNESS;
    }
    ...
    public boolean isJudge() {
        return this.participantType != null && 
               this.participantType == CaseParticipantTypeEnum.JUDGE;
    }
    ...
    public boolean isExpert() {
        return this.participantType != null && 
               this.participantType == CaseParticipantTypeEnum.EXPERT;
    }
} 