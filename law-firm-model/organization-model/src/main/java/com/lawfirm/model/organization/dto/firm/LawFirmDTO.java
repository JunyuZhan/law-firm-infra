...
public class LawFirmDTO extends BaseDTO {
    ...
    @Size(min = FirmFieldConstants.Name.MIN_LENGTH, max = FirmFieldConstants.Name.MAX_LENGTH, message = "名称长度必须在{min}到{max}之间")
    private String name;

    /**
     * 律所类型
     */
    @NotNull(message = "律所类型不能为空")
